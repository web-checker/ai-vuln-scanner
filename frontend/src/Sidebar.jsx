// 좌측 사이드바(네이비): 메뉴 + CSV 업로드 + 진단 실행 버튼.
import React, { useRef, useState } from 'react'

export default function Sidebar({ open, tab, setTab, health, session, total, doneCount, onUpload, onJudge, onReset, judging, runKind, setRunKind, assetSaved, onSaveAsset }) {
